...
namespace ZenithHealingCenter.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public OrdersController(IMedicalPackagesService medicalPackagesService, ShoppingCart shoppingCart, IOrdersService ordersService)
        {
            _medicalPackagesService = medicalPackagesService;
        ...
        {
            var item = await _medicalPackagesService.GetMedicalPackagesByIdAsync(id);
